<template lang="pug">
main.container.all-news-content--container
  ...
  ul.all-news__list
    li.all-news__list-item(v-for="(news, index) in allNews")
      a(href="/news")
        ...
        .all-news-content--style.all-news__description-p
          p {{ news.newsP }}
        .all-news-content--style.all-news-content--date {{ news.newsDate }}
</template>
